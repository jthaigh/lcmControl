...
int main(int argc, char** argv){
  ...
  try {
    ...
    std::cerr << "error reading the configuration file." << std::endl;
    return 1;
  }
  ...
  try{
    ...
    std::cerr<<"Error configuring LCM hardware!"<<std::endl;
    return 1;
  }
  std::cout<<"LCM hardware successfully configured! lcmControl.exe exiting..."<<std::endl;
  return 0;
}
